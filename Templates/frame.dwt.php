...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form3")) {
  $insertSQL = sprintf("INSERT INTO person_love (ord_id, goods_id, goods_name, goods_price, goods_stand, ord_sum) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "../pages/person_love.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_eplay, $eplay);
$query_productRec = sprintf("SELECT * FROM article_goods WHERE goods_id = %s", GetSQLValueString($colname_productRec, "text"));
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		  ...
		  <ul class="nav navbar-top-links navbar-left ">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="../pages/question.php"><i class="fa fa-gear fa-fw"></i> 常見問題</a>
                        </li>
                        <li><a href="../pages/aboutme.php"><i class="fa fa-gear fa-fw"></i> 關於我</a>
                        </li>
                        <li><a href="../pages/contactme.php"><i class="fa fa-user fa-fw"></i> 聯絡我</a>
                        </li>
          ...
          <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="../pages/login01.php"><i class="fa fa-gear fa-fw"></i> 登入會員</a>
                        </li>
                        <li><a href="../pages/personal_page.php"><i class="fa fa-user fa-fw"></i> 個人頁面</a>
                        </li>
                        <li><a href="../pages/personal_data.php"><i class="fa fa-gear fa-fw"></i> 個人資料</a>
                        </li>
                        <li><a href="../pages/addmem.php"><i class="fa fa-gear fa-fw"></i> 加入會員</a>
                        </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                  <a href="../pages/flot.html">1</a>
                              </li>
                                <li>
                                  <a href="../pages/morris.html">2</a>
                                </li>
                          </ul>
                            <!-- /.nav-second-level -->
                      </li>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="../pages/flot.html">日月潭</a>
                                </li>
                                <li>
                                  <a href="../pages/morris.html">墾丁</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="../pages/flot.html">旅遊</a>
                                </li>
                                <li>
                                  <a href="../pages/morris.html">美食</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                    ...
                    <tr>
                                            <th><table class="table table-bordered table-striped">
                                              <thead>
                                                <tr>
                                                  <th width="32%" bgcolor="#FFFFFF">編號：<?php echo $row_productRec['goods_id']; ?></th>
                                                  <td colspan="2"><?php echo $row_productRec['goods_name']; ?></td>
                                                </tr>
                                              </thead>
                                              <tbody>
                                                <tr>
                                                  <th rowspan="2"><img src="goodsimg/<?php echo $row_productRec['goods_img']; ?>" alt="" name="" width="165" height="165" /></th>
                                                  <td colspan="2"><?php echo $row_productRec['goods_desc']; ?></td>
                                                </tr>
                                                <tr>
                                                  <td colspan="2"><span class="style20">遊記網址&nbsp;:<a href="<?php echo $row_productRec['../pages/goods_stand']; ?>"><img src="../pages/photos/options.gif" longdesc="<?php echo $row_productRec['goods_stand']; ?>"></a><br />
                                                      <input type="image" name="imageField" id="imageField" src="../pages/photos/addcar.gif" />
                                                      ...
                                                      <input name="ord_id" type="hidden" id="ord_id" value="<?php echo $row_productRec['goods_id']; ?>" />
                                                  </span></td>
                                                </tr>
                                              </tbody>
                                            </table>
