...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO evaluationn (`comment`, score) VALUES (%s, %s)",
...
mysql_select_db($database_eplay, $eplay);
$query_Recordset1 = "SELECT * FROM evaluation";
$Recordset1 = mysql_query($query_Recordset1, $eplay) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);mysql_select_db($database_eplay, $eplay);
$query_Recordset1 = "SELECT * FROM evaluationn";
$Recordset1 = mysql_query($query_Recordset1, $eplay) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
                          ...
                          <form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                              <tbody>
                                <tr class="odd gradeA">
                                  <td width="24%">分數</td>
                                  <td width="76%"><div id="starBg" class="star_bg">
                                    <p>
                                      <label>
                                ...
                                <tr class="even gradeA">
                                  <td>留言</td>
                                  <td><textarea name="cont" cols="45" rows="10" id="cont"><?php echo $row_Recordset1['comment']; ?></textarea></td>
                                </tr>
                                <tr class="odd gradeA">
                                  <td>&nbsp;</td>
                                  <td><input type="submit" name="ok" id="ok" value="送出">
...
<script src ="../vendor/bubble.js"></script>
