...
mysql_select_db($database_eplay, $eplay);
$query_showgoodsRec = "SELECT food_goods.*,shop_item.item_name FROM food_goods INNER JOIN shop_item    ON shop_item.item_id=food_goods.item_id";
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-heading">美食管理</div>
                <!-- /.panel-heading -->
                      ...
                      <td width="550" colspan="2" bgcolor="#9DACBF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td colspan="2"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="2" bgcolor="#FFFFFF">
                            <tr>
                              <td bgcolor="#E3E9F1"><div align="center"><span class="style15">編號</span></div></td>
                              <td bgcolor="#E3E9F1"><div align="center">名稱</div></td>
                              <td bgcolor="#E3E9F1"><div align="center">分類</div></td>
                              <td bgcolor="#E3E9F1"><div align="left" class="style15">
                            ...
                            <tr>
                              ...
                              <td bgcolor="#E3E9F1"><a href="food_content.php?goods_id=<?php echo $row_showgoodsRec['goods_id']; ?>"><font color="#333399"><?php echo $row_showgoodsRec['goods_name']; ?></font></a></td>
                              <td bgcolor="#E3E9F1"><div align="center"><?php echo $row_showgoodsRec['item_name']; ?></div></td>
                              <td bgcolor="#E3E9F1"><div align="center"><?php echo $row_showgoodsRec['goods_price']; ?></div></td>
                        ...
                        <tr>
                          <td height="10"><div align="right">共<?php echo $totalRows_showgoodsRec ?> 種美食</div></td>
                          <td>&nbsp;
                            <table border="0">
                              <tr>
