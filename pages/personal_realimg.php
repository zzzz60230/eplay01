...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form3")) {
	move_uploaded_file($_FILES["realimage"]["tmp_name"], "personalimg\\" . $_FILES["realimage"]["name"]);
  $updateSQL = sprintf("UPDATE memberdata SET realimage=%s WHERE memId=%s",
                       GetSQLValueString($_FILES["realimage"]["name"], "text"),
...
mysql_select_db($database_eplay, $eplay);
$query_memRec = sprintf("SELECT * FROM memberdata WHERE memId = %s", GetSQLValueString($colname_memRec, "text"));
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-heading">變更頭貼</div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                    <table width="40%" border="0" align="left" cellpadding="0" cellspacing="1">
                      <tr>
                        <td width="14%"><div align="right">帳號：</div></td>
                      ...
                      <tr>
                        ...
                        <td><input type="file" name="realimage" id="realimage" /></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td><input type="image" name="imageField" id="imageField" src="photos/renew.gif" /></td>
                      </tr>
                    </table>
                    <p>&nbsp;</p>
