...
mysql_select_db($database_eplay, $eplay);
$query_productRec = sprintf("SELECT * FROM prefer_goods WHERE goods_id = %s", GetSQLValueString($colname_productRec, "text"));
                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                    <tr>
                                            <th><table class="table table-bordered table-striped">
                                              <tbody>
                                                  <tr>
                                                    <th width="250" height="500" rowspan="4"><img src="preferimg/<?php echo $row_productRec['goods_img']; ?>" alt="" name="" width="265" height="265" /></th>
                                                    <td colspan="4" bgcolor="#FFFFFF">編號：<?php echo $row_productRec['goods_id']; ?></td>
                                                  </tr>
                                                  <tr>
                                                    <td colspan="4" bgcolor="#FFE1F0"><?php echo $row_productRec['goods_name']; ?></td>
                                                  </tr>
                                                  <tr>
                                                    <td colspan="4" bgcolor="#FFFFFF"><?php echo $row_productRec['goods_desc']; ?></td>
                                                  </tr>
                                                  <tr>
                                                    <td colspan="4" bgcolor="#FFFFFF"><span class="style20">優惠網址&nbsp;:<a href="<?php echo $row_productRec['goods_stand']; ?>"><img src="photos/options.gif" longdesc="<?php echo $row_productRec['goods_stand']; ?>"></a><br />
