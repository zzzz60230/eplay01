                      ...
                      <div class="picDiv">
                        <form name="form1" method="post" action="">
                          <table width="100%" height="145" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td height="145" align="center"><table width="461" height="102" border="0" align="center">
                                <tr>
                                  <td width="368" bgcolor="#FFFFFF"><p class="style3">恭喜您已經成功加入本網站會員!!<br />
                                    請利用您所註冊的會員帳號密碼進行登入動作!</p></td>
                                  <td width="43" bgcolor="#FFFFFF"><p><img src="photos/options.gif" width="48" height="48" /></p>
                                  </td>
                                </tr>
                              </table>
                             <a href="login01.php"> <button type="button" class="btn btn-danger">登入會員</button></a></td>
                            </tr>
                          </table>
                        </form>
                      </div>
