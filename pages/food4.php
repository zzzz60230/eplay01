...
.style6 {color: #FF0000}
    ...
    #wrapper #page-wrapper .row .table.table-bordered.table-striped thead tr th {
	font-family: Verdana, Geneva, sans-serif;
}
    #wrapper #page-wrapper .row .table.table-bordered.table-striped tbody tr td em {
	font-family: "標楷體";
}
    #wrapper #page-wrapper .row .table.table-bordered.table-striped tbody tr td em {
	font-size: 24px;
    ...
    #wrapper #page-wrapper .row .table.table-bordered.table-striped tbody tr td {
	font-family: 標楷體;
}
    </style>
...
<div class="navbar-default sidebar" role="navigation">
        ...
        <div id="page-wrapper">
            <div class="row">
              <div class="masthead">
                <h3 class="text-muted">你現在瀏覽的是北部&quot;桃園&quot;</h3>
                <ul id="MenuBar1" class="MenuBarHorizontal">
                  <li>
                    <div align="center"><a class="MenuBarItemSubmenu" href="#">北部</a>
                      <ul>
                        <li><a href="food1.php">台北</a></li>
                        <li><a href="#">基隆</a></li>
                        <li><a href="food4.php">桃園</a></li>
                        <li><a href="#">新竹</a></li>
                      </ul>
                    </div>
                  </li>
                  <li>
                    <div align="center"><a href="#">中部</a></div>
                  </li>
                  <li>
                    <div align="center"><a href="#">南部</a></div>
                  </li>
                  <li>
                    <div align="center"><a class="MenuBarItemSubmenu" href="#">東部</a>
                      <ul>
                  ...
                  <li>
                    <div align="center"><a href="#">離島</a></div>
                  </li>
                </ul>
                <p>&nbsp;</p>
                <nav>
              ...
              <table class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th><a href="food1.php"><img src="../瑞容專題/向陽/cm20120715_66474_56617_e5f206ebba44fe7583ad4f5ff7aee57a690.jpg" width="300" height="200" alt="1"></a></th>
                    <th><p align="left">向陽農場是一個有向陽農場、觀光農場、向日葵的觀光農牧場，網友認為值得推薦的有：向日葵花田、向日葵花海、自助剪花、莊園婚禮、diy...(<a href="food1.php">繼續閱讀</a>)</p></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <th><img src="../瑞容專題/小人國/1097195954_l.jpg" width="300" height="200" alt="123"></th>
                    <td><p>小人國擁有100多座的世界迷你景觀建築+20多項遊樂設施+精彩主題表演+不受天氣影響的2500坪室內樂園以及體驗最受親子喜愛的動感樂園！</p></td>
                  </tr>
                  <tr>
                    <th><img src="../瑞容專題/巧克力/DSC00195.jpg" width="300" height="200" alt="123"></th>
                    <td><p>巧克力共和國為宏亞食品創立，為東南亞首座巧克力博物館。自民國六十五年以來，宏亞食品創造「77乳加」，已走過四十年的歷史，也創造了無數兒時回憶。</p></td>
                  </tr>
                  <tr>
                    <th><img src="../瑞容專題/石門/下載.jpg" width="300" height="200" alt="123"></th>
                    <td><p>石門水庫曾經是遠東最大的水庫，目前亦是台灣北部的重要水庫之一，一年四季，湖光山色，風景秀麗。</p></td>
                  </tr>
                  <tr>
                    <th><img src="../瑞容專題/慈湖陵寢/96cc92a1d9f57ccf0fe71e4952525fa643f7d06d.JPG" width="300" height="200" alt="123"></th>
                    <td><p>慈湖陵寢，正式名稱為「先總統蔣公陵寢」，位於臺灣桃園市大溪區與復興區交界處，是中華民國第1－5任總統蔣中正的陵園。</p></td>
                  </tr>
                </tbody>
              </table>
              <!-- /.col-lg-12 -->
