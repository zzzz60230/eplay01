...
mysql_select_db($database_eplay, $eplay);
$query_carRec = "SELECT shop_car.ord_id FROM shop_car";
...
mysql_select_db($database_eplay, $eplay);
$query_carRec = sprintf("SELECT * FROM shop_car WHERE shop_car.ord_id = %s ORDER BY temp_no DESC", GetSQLValueString($colname_carRec, "text"));
$carRec = mysql_query($query_carRec, $eplay) or die(mysql_error());
$row_carRec = mysql_fetch_assoc($carRec);
