...
$insertSQL = sprintf("INSERT INTO shop_goods (goods_id, goods_name, goods_price, goods_stand, goods_desc, goods_img, item_id) VALUES (%s, %s, %s, %s, %s, %s, %s)",
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-heading">上架景點</div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                   <span style="color: #000000; font-size: 20px;font-family: '微軟正黑體';"> <table width="100%" border="0" align="left" cellpadding="0" cellspacing="1">
                      <tr>
                        <td><div align="right"><span class="style15">景點分類</span></div></td>
                        <td><div align="left">
