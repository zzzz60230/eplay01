...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form3")) {
  $insertSQL = sprintf("INSERT INTO shop_car (ord_id, goods_id, goods_name, goods_price, goods_stand, ord_sum) VALUES (%s, %s, %s, %s, %s, %s)",
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-heading">景點</div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                    <table class="table table-bordered table-striped">
                      <thead>
                        <tr>
                          <th width="32%" bgcolor="#FFFFFF"><?php echo $row_productRec['item_id']; ?><?php echo $row_productRec['goods_id']; ?></th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td colspan="2" bgcolor="#FFFFFF"><?php echo $row_productRec['goods_desc']; ?></td>
                        </tr>
                        <tr>
                          <td colspan="2"><span class="style20">地址&nbsp;:<?php echo $row_productRec['goods_stand']; ?><br /> 
                            電話&nbsp;: <?php echo $row_productRec['goods_price']; ?><br />
<input type="image" name="imageField" id="imageField" src="photos/addcar.gif" />
