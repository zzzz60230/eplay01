            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="panel panel-default">
                  <div class="panel-heading">個人頁面</div>
                  <!-- /.panel-heading -->
                  <div class="panel-body">
                    ...
                    <form name="form4" method="post" action="">
                      <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <tbody>
                          <tr class="odd gradeX">
                            <td width="21%"><span class="active">帳號：</span>
                              <input name="memId" type="hidden" id="memId" value="<?php echo $row_personal_pageRec['memId']; ?>">
                            <?php echo $row_personal_pageRec['memId']; ?></td>
                            <td width="79%">暱稱： <?php echo $row_personal_pageRec['member_nickname']; ?></td>
                          </tr>
                          <tr class="odd gradeX">
                            <td><p><a><img src="personalimg/<?php echo $row_personal_pageRec['realimage']; ?>" alt="" name="realimage" width="250" height="250" id="realimage"></a></p></td>
                            <td><p>自我介紹:</p>
                              <p><?php echo $row_personal_pageRec['introduce']; ?></p>
                            <p>&nbsp;</p></td>
                          </tr>
                        </tbody>
                      </table>
...
<p>&nbsp;</p>
                    <p><span class="albuminfo">
                     <a href="personal_data.php"> <input name="reset" type="button" class="btn btn-primary" id="reset" onClick="MM_goToURL('parent','personal_data.php');return document.MM_returnValue" value="個人資料"></a>
                    </span><a href="love2_index.php">
                    <input name="reset2" type="button" class="btn btn-primary" id="reset2" onClick="MM_goToURL('parent','love2_index.php');return document.MM_returnValue" value="所有收藏">
                    </a></p>
<!-- /.panel-body -->
                </div>
                <!-- /.panel --></div>
