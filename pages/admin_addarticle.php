...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form3")) {
	move_uploaded_file($_FILES["goods_img"]["tmp_name"], "goodsimg\\" . $_FILES["goods_img"]["name"]);
$insertSQL = sprintf("INSERT INTO article_goods (goods_id, goods_name, goods_stand, goods_img, item_id) VALUES ( %s, %s, %s, %s, %s)",
...
$totalRows_itemRec = mysql_num_rows($itemRec);mysql_select_db($database_eplay, $eplay);
$query_itemRec = "SELECT * FROM shop_item";
$itemRec = mysql_query($query_itemRec, $eplay) or die(mysql_error());
$row_itemRec = mysql_fetch_assoc($itemRec);
$totalRows_itemRec = mysql_num_rows($itemRec);

$query_showitemRec = "SELECT shop_item.item_id,shop_item.item_name,count(article_goods.item_id) as num FROM shop_item LEFT OUTER JOIN article_goods    ON shop_item.item_id=article_goods.item_id GROUP BY shop_item.item_id ";
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-heading">上架遊記</div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                    <span style="color: #000000; font-size: 20px;font-family: '微軟正黑體';"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="1">
                      <tr>
                        <td width="21%" height="38" align="left"><div align="right">遊記編號 </div></td>
                        <td width="79%"><div align="left">
                          <input type="text" name="goods_id" id="goods_id" />
                        </div></td>
                      </tr>
                      <tr>
                        <td height="41" align="left"><div align="right"><span class="style15">遊記分類 </span></div></td>
                        <td><div align="left">
...
?>
                      ...
                      <tr>
                        <td height="38" align="left"><div align="right">遊記名稱 </div></td>
                        <td><div align="left">
                          <input name="goods_name" type="text" id="goods_name" />
                        </div></td>
                      </tr>
                      <tr>
                        <td height="39" align="left"><div align="right">遊記網址 </div></td>
                        <td><div align="left">
                          <input type="text" name="goods_stand" id="goods_stand" />
                        </div></td>
                      </tr>
                      <tr>
                        <td height="42" align="left"><div align="right">遊記圖片</div></td>
                        <td><input type="file" name="goods_img" id="goods_img" /></td>
                      </tr>
                      <tr>
                        <td height="42" align="left">&nbsp;</td>
                        <td><button type="image" class="btn btn-danger">新增</button>
                      </tr>
