        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-heading">旅遊地圖</div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                  ...
                  <button type="button" class="btn btn-danger"><a href="map/New north.php" class="btn-danger">新北</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Taipei.php" class="btn-danger">台北</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Taoyuan.php" class="btn-danger">桃園</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Keelung.php" class="btn-danger">基隆</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Yilan.php" class="btn-danger">宜蘭</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Hsinchu.php" class="btn-danger">新竹</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Taichung.php" class="btn-danger">台中</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Miaoli.php" class="btn-danger">苗栗</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Changhua.php" class="btn-danger">彰化</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Yunli.php" class="btn-danger">雲林</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Nantou.php" class="btn-danger">南投</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Chiayi.php" class="btn-danger">嘉義</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Tainan.php" class="btn-danger">台南</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Kaohsiung.php" class="btn-danger">高雄</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Pingtung.php" class="btn-danger">屏東</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Hualien.php" class="btn-danger">花蓮</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Taitung.php" class="btn-danger">台東</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Kinmen.php" class="btn-danger">金門</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Lianjiang.php" class="btn-danger">連江</a></button>
                  <button type="button" class="btn btn-danger"><a href="map/Penghu.php" class="btn-danger">澎湖</a></button>
                  
                
                  
                  <p>&nbsp;</p>
                  <p><div class="alert alert-danger" role="alert">所有景點</div>
                  <div class="embed-responsive embed-responsive-4by3">
                    <iframe src="https://www.google.com/maps/d/embed?mid=16a0pQA33n_Nw62G-ZXt50VSPSx-Ruyhg" width="640" height="480"></iframe></div></p>
                    <br> <br>
                    <p><div class="alert alert-danger" role="alert">所有美食</div>
                  <div class="embed-responsive embed-responsive-4by3">
                    <iframe src="https://www.google.com/maps/d/embed?mid=1iZo4R6oy6wQ5A7mqSggnmx56ghBCrvEg" width="640" height="480"></iframe></div></p>
