...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form3")) {
  $insertSQL = sprintf("INSERT INTO love_goods (goods_id, memId, goods_img, goods_name) VALUES (%s, %s, %s, %s)",
                ...
                <div class="panel-body">
                  <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                    <table class="table table-bordered table-striped">
                      <tbody>
                        <tr>
                          <th width="250" rowspan="4"><img src="goodsimg/<?php echo $row_productRec['goods_img']; ?>" alt="" width="250" height="250" /></th>
...
電話&nbsp;: <?php echo $row_productRec['goods_price']; ?></span></p>
    ...
    <div align="left" class="heart">
                            ...
                            <input name="goods_img" type="hidden" id="goods_img" value="<?php echo $row_productRec['goods_img']; ?>"></div>
                          </p></td>
                        </tr>
                      </tbody>
                    </table>
