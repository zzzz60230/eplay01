...
mysql_select_db($database_eplay, $eplay);
$query_productRec = "SELECT * FROM food_goods ORDER BY goods_date DESC";
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-heading">所有美食</div>
                <!-- /.panel-heading -->
                      ...
                      <table width="2" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><div id="showgoods2">
                            <table width="2" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><a href="food_content.php?goods_id=<?php echo $row_productRec['goods_id']; ?>"><img src="foodimg/<?php echo $row_productRec['goods_img']; ?>" alt="" width="165" height="165" /></a><a href="goods.php?goods_id=<?php echo $row_productRec['goods_id']; ?>"></a></td>
                              </tr>
                              <tr>
                                <td><b><font face="微軟正黑體"><div align="left" style="width:165px;height:50px;"><?php echo $row_productRec['goods_name']; ?></div>
                                </font></b></td>
                              </tr>
                              <tr>
                                <td><b><font face="微軟正黑體"><div align="left" style="width:165px;height:80px;"><span class="style19"><?php echo $row_productRec['goods_stand']; ?></span></div></font></b></td>
                              </tr>
                              <tr>
                                <td width="165"><div align="left"></div></td>
                              </tr>
                            </table>
                          </div>                          <a href="goods_content.php?goods_id=<?php echo $row_productRec['goods_id']; ?>"></a></td>
                        </tr>
                      </table>
                    </div>
