...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form3")) {
  $insertSQL = sprintf("INSERT INTO love_goods (memId, goods_id) VALUES (%s, %s)",
...
mysql_select_db($database_eplay, $eplay);
$query_productRec = "SELECT * FROM shop_goods ORDER BY goods_date DESC";
...
mysql_select_db($database_eplay, $eplay);
$query_mem = "SELECT * FROM memberdata";
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-heading">所有收藏</div>
                <!-- /.panel-heading -->
                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                    <?php do { ?>
                      ...
                      <table width="3" border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><div id="showgoods2">
                            <table width="2" border="0" align="center" cellpadding="0" cellspacing="0">
                              
                              <tr>
                                <td><a href="love_content.php?goods_id=<?php echo $row_productRec['goods_id']; ?>"><img src="goodsimg/<?php echo $row_productRec['goods_img']; ?>" alt="" width="165" height="165" /></a><a href="goods.php?goods_id=<?php echo $row_productRec['goods_id']; ?>"></a></td>
                              </tr>
                              <tr>
                                <td>
    
                                <b><font face="微軟正黑體"><div align="left" style="width:165px;height:50px;"><?php echo $row_productRec['goods_name']; ?></div></font></b></td>
                              ...
                              <tr>
                                <td><b><font face="微軟正黑體"><div align="left" style="width:165px;height:50px;"><span class="style19"><?php echo $row_productRec['goods_stand']; ?></span></div></font></b></td>
                              </tr>
                              <tr><td>
                              <script src="http://wow.techbrood.com/libs/jquery/jquery-1.11.1.min.js"></script>
    <div align="left" class="heart">
              ...
              <table border="0">
                <tr>
                  <td><?php if ($pageNum_productRec > 0) { // Show if not first page ?>
                    <a href="<?php printf("%s?pageNum_productRec=%d%s", $currentPage, 0, $queryString_productRec); ?>">第一頁</a>
                    <?php } // Show if not first page ?></td>
                  <td><?php if ($pageNum_productRec > 0) { // Show if not first page ?>
                    <a href="<?php printf("%s?pageNum_productRec=%d%s", $currentPage, max(0, $pageNum_productRec - 1), $queryString_productRec); ?>">上一頁</a>
                    <?php } // Show if not first page ?></td>
                  <td><?php if ($pageNum_productRec < $totalPages_productRec) { // Show if not last page ?>
                    <a href="<?php printf("%s?pageNum_productRec=%d%s", $currentPage, min($totalPages_productRec, $pageNum_productRec + 1), $queryString_productRec); ?>">下一頁</a>
                    <?php } // Show if not last page ?></td>
                  <td><?php if ($pageNum_productRec < $totalPages_productRec) { // Show if not last page ?>
                    <a href="<?php printf("%s?pageNum_productRec=%d%s", $currentPage, $totalPages_productRec, $queryString_productRec); ?>">最後一頁</a>
                    <?php } // Show if not last page ?></td>
                </tr>
              </table>
              </div>
