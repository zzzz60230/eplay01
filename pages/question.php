                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                          ...
                          <tbody>
                            ...
                            <tr class="even gradeC">
                              <td>A: 「行程推薦」就是由我們安排最完美的路線及行程，讓您不用煩惱安排行程的問題！</td>
                            </tr>
                            <tr class="odd gradeA">
                              <td>02.Q：請問上架的遊記、景點都是最新的嗎？</td>
                            </tr>
                            <tr class="even gradeA">
                              <td>A: 是的，我們都是提供最新的資訊給您們。</td>
                            </tr>
                            <tr class="odd gradeA">
                              <td>03.Q：想要提供意見給你們，要怎麼做?</td>
                            </tr>
                            <tr class="even gradeA">
                              <td>A: 點選左上角的「客服」→「聯絡我」，即可提供意見給我們哦!</td>
                            </tr>
                            <tr>
                              <td>04.Q：要多久以前可以排行程?</td>
                            </tr>
                            <tr class="odd gradeX">
                              <td>A：只要在您出發前都可以排行程。</td>
                            </tr>
                            <tr>
                              <th>會員相關問題</th>
                            </tr>
                            ...
                            <tr class="even gradeC">
                              <td>A:點選右上角的「會員管理 」→「登入會員」→「忘記密碼」，輸入Email來更改新密碼。</td>
                            </tr>
                            <tr class="odd gradeA">
                              <td>02.Q：如何加入會員？</td>
                            </tr>
                            <tr class="even gradeA">
                              <td>A: 點選右上角的「會員管理 」→「登入會員」→「加入會員」，即可變成我們的會員哦！</td>
                            </tr>
                            <tr class="odd gradeA">
                              <td>03.Q：要如何更改個人的資料?</td>
                            </tr>
                            <tr class="even gradeA">
                              <td>A: 點選右上角的「會員管理 」→「個人頁面」→「修改個人資料」，即可進行修改。</td>
                            </tr>
                          </tbody>
                        </table>
                        <!-- /.table-responsive -->
