...
if (isset($_POST['memId'])) {
  ...
  $MM_fldUserAuthorization = "memLevel";
  $MM_redirectLoginSuccess = "personal_data.php";
  $MM_redirectLoginFailed = "login01.php?Err=yes";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_eplay, $eplay);
  	
  $LoginRS__query=sprintf("SELECT memId, memPsw, memLevel FROM memberdata WHERE memId=%s AND memPsw=%s",
  GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
   
  $LoginRS = mysql_query($LoginRS__query, $eplay) or die(mysql_error());
  $loginFoundUser = mysql_num_rows($LoginRS);
  if ($loginFoundUser) {
    
    $loginStrGroup  = mysql_result($LoginRS,0,'memLevel');
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="panel panel-default">
                  <div class="panel-heading"> <i class="fa fa-bar-chart-o fa-fw"></i><span class="panel-title">會員登入</span>
                  ...
                  <div class="panel-body">
                    <div class="row">
                     ...
                     <tr>
                <td><?php if($_GET[Err]=="yes") { ?><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                        ...
                        <form ACTION="<?php echo $loginFormAction; ?>" id="form1" name="form1" method="POST">
                          <fieldset>
                            ...
                            <div class="form-group">
                              ...
                              <input name="memId" type="帳號" autofocus class="form-control" id="memId" placeholder="帳號">
                            </div>
                            <div class="form-group">
                              <input name="memPsw" type="password" class="form-control" id="memPsw" placeholder="密碼" value="">
                            </div>
                            <div class="checkbox">
                              <label>
                            ...
                            <p>
                              ...
                              <input type="submit" name="login" id="login_but" class="btn btn-primary" value="送出">
                              
                         <a href="addmem.php"><input type="button" name="add_but" id="add_but" value="加入會員" /></a>
   						 <a href="forget_pd.php"><input type="button" name="forget_but" id="forgot_but" value="忘記密碼" /></a>
                            </p>
                          </fieldset>
                        </form>
                      </div>
