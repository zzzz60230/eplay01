...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form3")) {
	move_uploaded_file($_FILES["goods_img"]["tmp_name"], "personal_pic\\" . $_FILES["goods_img"]["name"]);

	$insertSQL = sprintf("INSERT INTO personal_pic (memId, goods_name, goods_price, goods_stand, goods_desc, goods_img, item_id) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
if (isset($_SESSION['MM_Username'])) {
  $colname_memRec = $_SESSION['MM_Username'];
}
mysql_select_db($database_eplay, $eplay);
$query_memRec = sprintf("SELECT * FROM memberdata WHERE memberdata.memId = %s", GetSQLValueString($colname_memRec, "text"));
$memRec = mysql_query($query_memRec, $eplay) or die(mysql_error());
$row_memRec = mysql_fetch_assoc($memRec);
$totalRows_memRec = mysql_num_rows($memRec);

$query_showitemRec = "SELECT shop_item.item_id,shop_item.item_name,count(personal_pic.item_id) as num FROM shop_item LEFT OUTER JOIN personal_pic    ON shop_item.item_id=personal_pic.item_id GROUP BY shop_item.item_id ";
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-heading">新增照片</div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="1">
                      <tr>
                        <td><div align="right"><span class="style15">分類</span></div></td>
                        <td><div align="left">
                          <select name="item_id" id="item_id">
                            <?php
do {  
?>
                            <option value="<?php echo $row_itemRec['item_id']?>"><?php echo $row_itemRec['item_name']?></option>
                            <?php
...
?>
                        ...
                        <td><div align="left">
                           <input name="memId" type="hidden" id="memId" value="<?php echo $row_memRec['memId']; ?>">
                          <?php echo $row_memRec['memId']; ?></div></td>
                      </tr>
                      <tr>
                        <td><div align="right">名稱</div></td>
                        <td><div align="left">
                      ...
                      <tr>
                        ...
                        <td><div align="left">
                          <input type="text" name="goods_stand" id="goods_stand" />
                        </div></td>
                      </tr>
                      <tr>
                        <td><div align="right">說明 </div></td>
                        <td colspan="3"><div align="left">
                          <textarea name="goods_desc" id="goods_desc" cols="65" rows="5"></textarea>
                        </div></td>
                      </tr>
                      <tr>
                        <td><div align="right"></div></td>
                        <td colspan="3"><div align="left">
                          <input type="image" name="imageField" id="imageField" src="photos/add.gif" />
                        </div></td>
                      </tr>
                    </table>
                    <p>&nbsp;</p>
