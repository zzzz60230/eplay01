...
<div id="wrapper">
  ...
  <select name="jumpMenu2" id="jumpMenu2" onChange="MM_jumpMenu('parent',this,1)">
                        ...
                        <option value="stroke_miaoli.php" selected="selected">苗栗</option>
      ...
      <div class="alert alert-warning" role="alert">
                      <p><img src="../photos/icons8-orthogonal-view-24.png" width="24" height="24">苗栗行程(一)<br>
                      </p>
                      
                      <p><strong>Day1■ 巧克力雲莊巧克力DIY體驗活動→三義丫箱寶→老吳鐵馬手工臭豆腐→天空之城</strong>  </p>
                      
                      <p><strong>Day2■山板樵休閒農場→漫時光咖啡→卓也小屋藍染體驗及吃天然植物染色霜淇淋→大補內彈珠汽水觀光工廠</strong></p>
                      
                      <p><strong>Day3■ 龍騰斷橋→勝興車站→春田窯捏陶土玩拉坏</strong></p>
                      
                      </div>
                      <p>&nbsp;</p>
                      <p><strong>Day1■ 巧克力雲莊巧克力DIY體驗活動→三義丫箱寶→老吳鐵馬手工臭豆腐→天空之城</strong></p>
        <div class="embed-responsive embed-responsive-4by3">
      <iframe src="https://www.google.com/maps/d/u/0/embed?mid=15_u8Q4GzwUWvHDW-u2eflB96ruBkkrxi" width="640" height="480">class="embed-responsive-item"></iframe></div>
                      </p>
      <p>&nbsp;</p>
                      <p><strong>Day2■山板樵休閒農場→漫時光咖啡→卓也小屋藍染體驗及吃天然植物染色霜淇淋→大補內彈珠汽水觀光工廠</strong></p>
      <div class="embed-responsive embed-responsive-4by3">
      <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1Bv_GrvRgJV5_P1nx1tddsQ1kRqK15HNl" width="640" height="480">class="embed-responsive-item"></iframe></div>
</p>
<p>&nbsp;</p>
<p><strong>Day3■ 龍騰斷橋→勝興車站→春田窯捏陶土玩拉坏</strong></p>
<div class="embed-responsive embed-responsive-4by3">
  <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1aBhDcQgJ1TsW8KwPlqxGCllIhwwxPN7n" width="640" height="480">class="embed-responsive-item"></iframe></div>
</p>


<p>&nbsp;</p>
<div class="alert alert-warning" role="alert">
<p><img src="../photos/icons8-orthogonal-view-24.png" width="24" height="24">苗栗行程(二)<br>
        </p>
        
        <p><strong>Day1■ 主題彩繪稻→藺草垂坤食品(伴手禮)→南窩綠丘(拍祕境)→通霄精鹽廠泡腳玩水→後龍好</strong></p>
        <p><strong>Day2■ 山板樵臉譜文化生→三義木雕博物館→東河吊橋</strong></p>
        <p><strong>Day3■ 萊溪護魚步→四十二坪步道(42份生態湧泉)吃原住民風→向天湖(貓頭鷹DIY)→瓦祿產業文化館→南庄老街</strong></p>
        
      </div>
<p>&nbsp;</p>
<p><strong>Day1■ 主題彩繪稻→藺草垂坤食品(伴手禮)→南窩綠丘(拍祕境)→通霄精鹽廠泡腳玩水→後龍好</strong></p>
<div class="embed-responsive embed-responsive-4by3">
  <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1N2IDU5xqTOuEQbymAaN2iK1bJpv-O9Yt" width="640" height="480">class="embed-responsive-item"></iframe></div>
</p>
<p>&nbsp;</p>
<p><strong>Day2■ 山板樵臉譜文化生→三義木雕博物館→東河吊橋</strong></p>
<div class="embed-responsive embed-responsive-4by3">
  <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1NSCFyDe2Im3R65KhJ-ou0FzcVhuG9_da" width="640" height="480">class="embed-responsive-item"></iframe></div>
</p>
<p>&nbsp;</p>
<p><strong>Day3■ 萊溪護魚步→四十二坪步道(42份生態湧泉)吃原住民風→向天湖(貓頭鷹DIY)→瓦祿產業文化館→南庄老街</strong></p>
<div class="embed-responsive embed-responsive-4by3">
  <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1IsHCrlns1sLJU5-opSps-DYr5y1JJ5Or" width="640" height="480">class="embed-responsive-item"></iframe></div>
</p>
