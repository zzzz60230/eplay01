...
if ((isset($_GET['goods_id'])) && ($_GET['goods_id'] != "") && (isset($_POST['goods_id']))) {
  $deleteSQL = sprintf("DELETE FROM prefer_goods WHERE goods_id=%s",
...
mysql_select_db($database_eplay, $eplay);
$query_showgoodsRec = "SELECT prefer_goods.*,shop_item.item_name FROM prefer_goods INNER JOIN shop_item    ON shop_item.item_id=prefer_goods.item_id";
                   ...
                   <span style="color: #000000; font-size: 20px;font-family: '微軟正黑體';"> <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="550" colspan="2" bgcolor="#9DACBF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td colspan="2"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="2" bgcolor="#FFFFFF">
                            <tr>
                              ...
                              <td bgcolor="#E3E9F1"><div align="center">網址</div></td>
                            ...
                            <tr>
                              ...
                              <td bgcolor="#E3E9F1"><a href="prefer_content.php?goods_id=<?php echo $row_showgoodsRec['goods_id']; ?>"><font color="#333399"><?php echo $row_showgoodsRec['goods_name']; ?></font></a></td>
                        ...
                        <tr>
                          <td height="10"><div align="right">共<?php echo $totalRows_showgoodsRec ?> 種優惠</div></td>
                          <td>&nbsp;
                            <table border="0">
                              <tr>
