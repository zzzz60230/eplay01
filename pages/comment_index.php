...
mysql_select_db($database_eplay, $eplay);
$query_newsMain = "SELECT * FROM `comment` ORDER BY postDate ASC";
$query_limit_newsMain = sprintf("%s LIMIT %d, %d", $query_newsMain, $startRow_newsMain, $maxRows_newsMain);
$newsMain = mysql_query($query_limit_newsMain, $eplay) or die(mysql_error());
$row_newsMain = mysql_fetch_assoc($newsMain);
                ...
                <div class="panel-body">
                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                      ...
                      <tr>
                        ...
                        <td><?php if ($totalRows_newsMain == 0) { // Show if recordset empty ?>
                          ...
                          <table width="650" border="0">
                            <tr>
                              <td align="left">&nbsp;</td>
                              <td align="right"><a href="admin_news.php"><img src="photos/adim.gif" alt="消息管理" width="68" height="15" border="0" /></a></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>
                    ...
                    <table width="200" border="1">
                      <tr>
                        <td><?php echo $row_newsMain['type']; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row_newsMain['NO1']; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row_newsMain['NO2']; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row_newsMain['NO3']; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row_newsMain['NO4']; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row_newsMain['NO5']; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row_newsMain['NO6']; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row_newsMain['NO7']; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row_newsMain['NO8']; ?></td>
                      </tr>
                    </table>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
