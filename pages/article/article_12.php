              ...
              <div class="col-lg-12">
                ...
                <form name="form1" method="post" action="">
                  <table class="table table-bordered table-striped">
                    <tbody>
                      <tr>
                        <th width="250" height="250" rowspan="3"><img name="" src="../goodsimg/1539358253548.jpg" width="250" height="242" alt=""></th>
                        <td colspan="4" bgcolor="#FFFFFF">編號：A0012</td>
                      </tr>
                      <tr>
                        <td colspan="4" bgcolor="#FFE1F0">桃園景點懶人包》周末就醬玩桃園 一日遊 二日遊行程規畫 情侶約會景點</td>
                      </tr>
                      <tr>
                  ...
                  <p><div class="embed-responsive embed-responsive-4by3">
                    <iframe src="https://fullfenblog.tw/taoyuan-lazy-bag/"></iframe></div></p>
                </form>
</div>
                </div>
                <p>&nbsp;</p>
