                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                    <tr>
                                            <th><table class="table table-bordered table-striped">
                                              <tbody>
                                                  <tr>
                                                    <th width="250" height="250" rowspan="3"><img src="goodsimg/<?php echo $row_productRec['goods_img']; ?>" alt="" name="" width="265" height="265" /></th>
                                                    <td colspan="4" bgcolor="#FFFFFF"><span class="alert">編號：<?php echo $row_productRec['goods_id']; ?></span></td>
                                                  </tr>
                                                  <tr>
                                                    <td colspan="4" bgcolor="#FFE1F0"><span class="alert"><?php echo $row_productRec['goods_name']; ?></span></td>
                                                  </tr>
                                                  <tr>
                                                    <td colspan="4" bgcolor="#FFFFFF"><span class="style20">遊記網址&nbsp;:<a href="<?php echo $row_productRec['goods_stand']; ?>"><img src="photos/options.gif" longdesc="<?php echo $row_productRec['goods_stand']; ?>"></a><br />
