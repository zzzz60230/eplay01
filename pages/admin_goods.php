        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-heading">景點管理</div>
                <!-- /.panel-heading -->
                  ...
                  <form name="form3" enctype="multipart/form-data" method="POST">
                    ...
                    <tr>
                      <td width="550" colspan="2" bgcolor="#9DACBF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td colspan="2"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="2" bgcolor="#FFFFFF">
                            ...
                            <tr>
                              ...
                              <td bgcolor="#E3E9F1"><a href="goods_content.php?goods_id=<?php echo $row_showgoodsRec['goods_id']; ?>"><font color="#333399"><?php echo $row_showgoodsRec['goods_name']; ?></font></a></td>
                        ...
                        <tr>
                          <td height="10"><div align="right">共<?php echo $totalRows_showgoodsRec ?> 種景點</div></td>
                          <td>&nbsp;
                            <table border="0">
                              <tr>
