...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form3")) {
 	...
 	move_uploaded_file($_FILES["goods_img"]["tmp_name"], "preferimg\\" . $_FILES["goods_img"]["name"]);

	$insertSQL = sprintf("INSERT INTO prefer_goods (goods_id, goods_name, goods_stand, goods_desc, goods_img) VALUES (%s, %s, %s, %s, %s)",
...
$query_showitemRec = "SELECT shop_item.item_id,shop_item.item_name,count(prefer_goods.item_id) as num FROM shop_item LEFT OUTER JOIN prefer_goods    ON shop_item.item_id=prefer_goods.item_id GROUP BY shop_item.item_id ";
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-heading">上架優惠</div>
                <!-- /.panel-heading -->
                ...
                <span style="color: #000000; font-size: 20px;font-family: '微軟正黑體';"> 
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="2">
                      <tr>
                        
                        <td width="4%"><div align="right">編號</div></td>
