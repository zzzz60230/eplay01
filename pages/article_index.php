...
mysql_select_db($database_eplay, $eplay);
$query_productRec = "SELECT * FROM article_goods ORDER BY goods_date DESC";
              ...
              <div class="col-lg-3">
                  <div class="panel panel-default" >
                    ...
                    <div class="panel-body" >
                      <p><a href="article_content.php?goods_id=<?php echo $row_productRec['goods_id']; ?>"><img src="goodsimg/<?php echo $row_productRec['goods_img']; ?>" alt="" width="250" height="250" /></a></p>
                    </div>
                  </div>
              </div>
