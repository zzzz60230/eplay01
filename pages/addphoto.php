...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form3")) {
  $insertSQL = sprintf("INSERT INTO albumphoto (ap_subject, ap_picurl) VALUES (%s, %s)",
                       GetSQLValueString($_POST['addtext'], "text"),
                       GetSQLValueString($_POST['addpicule'], "text"));

  mysql_select_db($database_eplay, $eplay);
  $Result1 = mysql_query($insertSQL, $eplay) or die(mysql_error());

  $insertGoTo = "personal_page.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_eplay, $eplay);
$query_Recordset3 = "SELECT albumphoto.ap_subject, albumphoto.ap_picurl FROM albumphoto";
$Recordset3 = mysql_query($query_Recordset3, $eplay) or die(mysql_error());
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="panel panel-default">
                  <div class="panel-heading">上傳照片</div>
                  <!-- /.panel-heading -->
                  <div class="panel-body">
                    ...
                    <form action="<?php echo $editFormAction; ?>" name="form3" enctype="multipart/form-data" method="POST">
                      <p>選擇要上傳的照片：
                        <label for="picule"></label>
                        <input name="addpicule" type="file" id="picule">
                      </p>
                      <p>評論</p>
                      <p>
                      ...
                      <p>
                        <input type="submit" name="add05" id="add05" value="送出">
                      </p>
                      <p>&nbsp;</p>
