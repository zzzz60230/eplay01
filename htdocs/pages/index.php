            ...
            <div class="row">
                <div class="col-lg-8">
                  ...
                  <div class="row show-grid" style="height:50px";>
                                <?php do { ?>
                                  <div class="col-xs-6 col-md-3"><a href="goods_content.php?goods_id=<?php echo $row_goodsRec['goods_id']; ?>"><img name="" src="goodsimg/<?php echo $row_goodsRec['goods_img']; ?>" width="180" height="180" alt=""></a><br>
                                   <b> <span style="color: #000000; font-size: 20px;font-family: '微軟正黑體';"> <?php echo $row_goodsRec['goods_name']; ?></span></b>
                                </div>
